...
| 平台 | 下载 |
|------|------|
| Android (APK) | [下载 APK](https://github.com/Blue-Mink/fnos-vm-dongguaha/releases/download/v18.0/Home-Assistant.apk) |
| Android (Google Play) | [Google Play](https://play.google.com/store/apps/details?id=io.homeassistant.companion.android) |
| iOS | [App Store](https://apps.apple.com/cn/app/home-assistant/id1099568401) |
